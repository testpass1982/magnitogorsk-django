"""
Django settings for magnitogorsk_site project.
...
SECRET_KEY = 'ejajo*$pu(-$#$$cs)%css7!fotr^sj@(=+%k-oj_*14rv%=_c'
...
ROOT_URLCONF = 'magnitogorsk_site.urls'
...
WSGI_APPLICATION = 'magnitogorsk_site.wsgi.application'
